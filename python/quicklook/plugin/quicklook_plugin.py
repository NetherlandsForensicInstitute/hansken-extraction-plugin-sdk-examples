...
class QuickLookPlugin(DeferredExtractionPlugin):
    ...
    def process(self, trace: ExtractionTrace, data_context, searcher):
        ...
        files_trace = search_for_trace(searcher, f"data.raw.fileType='Tab Separated Values' AND path='{files_path}'")
        ...
        thumbnails_trace = search_for_trace(searcher,
                                            f"data.raw.fileType='Tab Separated Values' AND path='{thumbnails_path}'")
